...
for outer_fold, (train_idx, test_idx) in enumerate(outer_cv.split(X, y)):
    ...
    print(f"Best FS: {best_fs_config}, RF: {best_rf_params}")
    ...
    outer_results.append({
        'fold': outer_fold + 1,
        'best_fs': best_fs_config['method'],
        'fs_param': best_fs_config['param'],
...
print(f"\nMean ROC AUC: {results_df['roc_auc'].mean():.3f} ± {results_df['roc_auc'].std():.3f}")